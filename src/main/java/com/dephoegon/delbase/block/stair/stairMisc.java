...
public class stairMisc {
    ...
    public static final DeferredBlock<StairBlock> END_STONE_STAIR = register("end_stone_stair",
            ()-> new stairBlock(END_STONE, BlockBehaviour.Properties.ofFullCopy(END_STONE).sound(SoundType.STONE), false, 0, 0, null));
    public static final DeferredBlock<StairBlock> BONE_BLOCK_STAIR = register("bone_block_stair",
            ()-> new stairBlock(BONE_BLOCK, BlockBehaviour.Properties.ofFullCopy(BONE_BLOCK).sound(SoundType.BONE_BLOCK), false, 0, 0, null));
    public static final DeferredBlock<StairBlock> DRIED_KELP_STAIR = register("dried_kelp_stair",
            ()-> new leafStair(DRIED_KELP_BLOCK, DRIED_KELP_BLOCK, SoundType.GRASS, true, null),4001);
    public static final DeferredBlock<StairBlock> GLOWSTONE_STAIR = register("glowstone_stair",
    ...
    public static final DeferredBlock<StairBlock> BASALT_STAIR = register("basalt_stair",
            ()-> new stairBlock(BASALT, BlockBehaviour.Properties.ofFullCopy(BASALT).sound(SoundType.STONE), false, 0, 0, null));
    public static final DeferredBlock<StairBlock> POLISHED_BASALT_STAIR = register("polished_basalt_stair",
            ()-> new stairBlock(POLISHED_BASALT, BlockBehaviour.Properties.ofFullCopy(POLISHED_BASALT).sound(SoundType.STONE), false, 0, 0, null));
    public static final DeferredBlock<StairBlock> SMOOTH_BASALT_STAIR = register("smooth_basalt_stair",
            ()-> new stairBlock(SMOOTH_BASALT, BlockBehaviour.Properties.ofFullCopy(SMOOTH_BASALT).sound(SoundType.STONE), false, 0, 0, null));
    public static final DeferredBlock<StairBlock> COBBLED_BASALT_STAIR = register("cobbled_basalt_stair",
            ()-> new stairBlock(BASALT, BlockBehaviour.Properties.ofFullCopy(BASALT).sound(SoundType.STONE), false, 0, 0, null));
    public static final DeferredBlock<StairBlock> RAW_GOLD_STAIR = register("raw_gold_stair",
            ()-> new stairBlock(RAW_GOLD_BLOCK, BlockBehaviour.Properties.ofFullCopy(RAW_GOLD_BLOCK).sound(SoundType.METAL), false, 0, 0, null));
    public static final DeferredBlock<StairBlock> RAW_COPPER_STAIR = register("raw_copper_stair",
    ...
    public static final DeferredBlock<StairBlock> RAW_IRON_STAIR = register("raw_iron_stair",
            ()-> new stairBlock(RAW_IRON_BLOCK, BlockBehaviour.Properties.ofFullCopy(RAW_IRON_BLOCK).sound(SoundType.METAL), false, 0, 0, null));
    public static final DeferredBlock<StairBlock> COAL_BLOCK_STAIR = register("coal_block_stair",
            ()-> new stairBlock(COAL_BLOCK, BlockBehaviour.Properties.ofFullCopy(COAL_BLOCK).sound(SoundType.WOOD), true, 15, 30, null), 16000);
    public static final DeferredBlock<StairBlock> CRACKED_POLISHED_BLACKSTONE_BRICK_STAIR = register("cracked_polished_blackstone_brick_stair",
    ...
    public static final DeferredBlock<StairBlock> CHISELED_POLISHED_BLACKSTONE_STAIR = register("chiseled_polished_blackstone_stair",
    ...
    public static final DeferredBlock<StairBlock> DRIPSTONE_STAIR = register("dripstone_stair",
            ()-> new stairBlock(DRIPSTONE_BLOCK, BlockBehaviour.Properties.ofFullCopy(DRIPSTONE_BLOCK).sound(SoundType.STONE), false, 0, 0, null));
    public static final DeferredBlock<StairBlock> NETHERRACK_STAIR = register("netherrack_stair",
            ()-> new stairBlock(NETHERRACK, BlockBehaviour.Properties.ofFullCopy(NETHERRACK).sound(SoundType.NETHERRACK), false, 0, 0, null));
    public static final DeferredBlock<StairBlock> SHROOMLIGHT_STAIR = register("shroomlight_stair",
    ...
    public static final DeferredBlock<StairBlock> MAGMA_BLOCK_STAIR = register("magma_block_stair",
    ...
    public static final DeferredBlock<StairBlock> PACKED_MUD_STAIR = register("packed_mud_stair",
            ()-> new stairBlock(PACKED_MUD, BlockBehaviour.Properties.ofFullCopy(PACKED_MUD).sound(SoundType.PACKED_MUD), false, 0, 0, null));
    public static final DeferredBlock<StairBlock> SCULK_STAIR = register("sculk_stair",
            ()-> new stairBlock(SCULK, BlockBehaviour.Properties.ofFullCopy(SCULK).sound(SoundType.SCULK), false, 0, 0, null));
    public static final DeferredBlock<StairBlock> MUD_STAIR = register("mud_stair",
            ()-> new stairBlock(MUD, BlockBehaviour.Properties.ofFullCopy(MUD).sound(SoundType.MUD), false, 0, 0, null));
    public static final DeferredBlock<StairBlock> MUDDY_MANGROVE_ROOT_STAIR = register("muddy_mangrove_root_stair",
            ()-> new leafStair(MUDDY_MANGROVE_ROOTS, MUDDY_MANGROVE_ROOTS, SoundType.MUDDY_MANGROVE_ROOTS, false, null));
    public static final DeferredBlock<StairBlock> MANGROVE_ROOT_STAIR = register("mangrove_root_stair",
            ()-> new leafStair(MANGROVE_ROOTS, MANGROVE_ROOTS, SoundType.MANGROVE_ROOTS, true, null));
    public static final DeferredBlock<StairBlock> OCHRE_FROGLIGHT_STAIR = register("ochre_froglight_stair",
    ...
    public static final DeferredBlock<StairBlock> VERDANT_FROGLIGHT_STAIR = register("verdant_froglight_stair",
    ...
    public static final DeferredBlock<StairBlock> PEARLESCENT_FROGLIGHT_STAIR = register("pearlescent_froglight_stair",
