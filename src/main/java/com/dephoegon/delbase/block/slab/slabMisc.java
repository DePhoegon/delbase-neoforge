...
import static net.minecraft.world.level.block.Blocks.DRIED_KELP_BLOCK;
...
public class slabMisc {
    ...
    public static final DeferredBlock<SlabBlock> END_STONE_SLAB = register("end_stone_slab",
            ()-> new slabBlock(BlockBehaviour.Properties.ofFullCopy(END_STONE).sound(SoundType.STONE)
                    ,"","","", false, 0, 0, null));
    public static final DeferredBlock<SlabBlock> BONE_BLOCK_SLAB = register("bone_block_slab",
            ()-> new slabBlock(BlockBehaviour.Properties.ofFullCopy(BONE_BLOCK).sound(SoundType.BONE_BLOCK)
                    ,"","","", false, 0, 0, null));
    public static final DeferredBlock<SlabBlock> DRIED_KELP_SLAB = register("dried_kelp_slab",
            ()-> new leafSlab(DRIED_KELP_BLOCK, SoundType.GRASS, true, null),4001);
    public static final DeferredBlock<SlabBlock> GLOWSTONE_SLAB = register("glowstone_slab",
            ()-> new slabBlock(BlockBehaviour.Properties.ofFullCopy(GLOWSTONE).sound(SoundType.GLASS).lightLevel((blockState)-> 15)
                    ,"","","", false, 0, 0, null));
    public static final DeferredBlock<SlabBlock> BASALT_SLAB = register("basalt_slab",
            ()-> new slabBlock(BlockBehaviour.Properties.ofFullCopy(BASALT).sound(SoundType.STONE)
                    ,"","","", false, 0, 0, null));
    public static final DeferredBlock<SlabBlock> POLISHED_BASALT_SLAB = register("polished_basalt_slab",
            ()-> new slabBlock(BlockBehaviour.Properties.ofFullCopy(POLISHED_BASALT).sound(SoundType.STONE)
                    ,"","","", false, 0, 0, null));
    public static final DeferredBlock<SlabBlock> SMOOTH_BASALT_SLAB = register("smooth_basalt_slab",
            ()-> new slabBlock(BlockBehaviour.Properties.ofFullCopy(SMOOTH_BASALT).sound(SoundType.STONE)
                    ,"","","", false, 0, 0, null));
    public static final DeferredBlock<SlabBlock> RAW_GOLD_SLAB = register("raw_gold_slab",
            ()-> new slabBlock(BlockBehaviour.Properties.ofFullCopy(RAW_GOLD_BLOCK).sound(SoundType.METAL)
                    ,"","","", false, 0, 0, null));
    public static final DeferredBlock<SlabBlock> RAW_COPPER_SLAB = register("raw_copper_slab",
            ()-> new slabBlock(BlockBehaviour.Properties.ofFullCopy(RAW_COPPER_BLOCK).sound(SoundType.METAL)
                    ,"","","", false, 0, 0, null));
    public static final DeferredBlock<SlabBlock> RAW_IRON_SLAB = register("raw_iron_slab",
            ()-> new slabBlock(BlockBehaviour.Properties.ofFullCopy(RAW_IRON_BLOCK).sound(SoundType.METAL)
                    ,"","","", false, 0, 0, null));
    public static final DeferredBlock<SlabBlock> COAL_BLOCK_SLAB = register("coal_block_slab",
            ()-> new slabBlock(BlockBehaviour.Properties.ofFullCopy(COAL_BLOCK).sound(SoundType.WOOD), true, 15, 30, null),16000);
    public static final DeferredBlock<SlabBlock> CRACKED_POLISHED_BLACKSTONE_BRICK_SLAB = register("cracked_polished_blackstone_brick_slab",
            ()-> new slabBlock(BlockBehaviour.Properties.ofFullCopy(CRACKED_POLISHED_BLACKSTONE_BRICKS).sound(SoundType.STONE)
                    ,"","","", false, 0, 0, null));
    public static final DeferredBlock<SlabBlock> CHISELED_POLISHED_BLACKSTONE_SLAB = register("chiseled_polished_blackstone_slab",
            ()-> new slabBlock(BlockBehaviour.Properties.ofFullCopy(CHISELED_POLISHED_BLACKSTONE).sound(SoundType.STONE)
                    ,"","","", false, 0, 0, null));
    public static final DeferredBlock<SlabBlock> DRIPSTONE_SLAB = register("dripstone_slab",
            ()-> new slabBlock(BlockBehaviour.Properties.ofFullCopy(DRIPSTONE_BLOCK).sound(SoundType.STONE)
                    ,"","","", false, 0, 0, null));
    public static final DeferredBlock<SlabBlock> NETHERRACK_SLAB = register("netherrack_slab",
            ()-> new slabBlock(BlockBehaviour.Properties.ofFullCopy(NETHERRACK).sound(SoundType.NETHERRACK)
                    ,"","","", false, 0, 0, null));
    public static final DeferredBlock<SlabBlock> SHROOMLIGHT_SLAB = register("shroomlight_slab",
            ()-> new slabBlock(BlockBehaviour.Properties.ofFullCopy(SHROOMLIGHT).sound(SoundType.SHROOMLIGHT).lightLevel((blockstate) -> 15)
                    ,"","","", false, 0, 0, null));
    public static final DeferredBlock<SlabBlock> MAGMA_BLOCK_SLAB = register("magma_block_slab",
            ()-> new slabBlock(BlockBehaviour.Properties.ofFullCopy(MAGMA_BLOCK).sound(SoundType.MOSS).lightLevel((blockstate) -> 3)
                    ,"","","", false, 0, 0, null));
    public static final DeferredBlock<SlabBlock> PACKED_MUD_SLAB = register("packed_mud_slab",
            ()-> new slabBlock(BlockBehaviour.Properties.ofFullCopy(PACKED_MUD).sound(SoundType.PACKED_MUD)
                    ,"","","", false, 0, 0, null));
    public static final DeferredBlock<SlabBlock> SCULK_SLAB = register("sculk_slab",
            ()-> new slabBlock(BlockBehaviour.Properties.ofFullCopy(SCULK).sound(SoundType.SCULK)
                    ,"","","", false, 0, 0, null));
    public static final DeferredBlock<SlabBlock> MUD_SLAB = register("mud_slab",
            ()-> new slabBlock(BlockBehaviour.Properties.ofFullCopy(MUD).sound(SoundType.MUD)
                    ,"","","", false, 0, 0, null));
    public static final DeferredBlock<SlabBlock> MUDDY_MANGROVE_ROOT_SLAB = register("muddy_mangrove_root_slab",
            ()-> new leafSlab(MUDDY_MANGROVE_ROOTS, SoundType.MUDDY_MANGROVE_ROOTS, false, null));
    public static final DeferredBlock<SlabBlock> MANGROVE_ROOT_SLAB = register("mangrove_root_slab",
            ()-> new leafSlab(MANGROVE_ROOTS, SoundType.MANGROVE_ROOTS, false, null));
    public static final DeferredBlock<SlabBlock> OCHRE_FROGLIGHT_SLAB = register("ochre_froglight_slab",
            ()-> new slabBlock(BlockBehaviour.Properties.ofFullCopy(OCHRE_FROGLIGHT).sound(SoundType.FROGLIGHT).lightLevel((blockstate) -> 15)
                    ,"","","", false, 0, 0, null));
    public static final DeferredBlock<SlabBlock> VERDANT_FROGLIGHT_SLAB = register("verdant_froglight_slab",
            ()-> new slabBlock(BlockBehaviour.Properties.ofFullCopy(VERDANT_FROGLIGHT).sound(SoundType.FROGLIGHT).lightLevel((blockstate) -> 15)
                    ,"","","", false, 0, 0, null));
    public static final DeferredBlock<SlabBlock> PEARLESCENT_FROGLIGHT_SLAB = register("pearlescent_froglight_slab",
