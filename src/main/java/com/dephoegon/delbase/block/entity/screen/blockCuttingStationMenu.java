...
import com.dephoegon.delbase.aid.util.ItemCapabilityMenuHelper;
...
public class blockCuttingStationMenu extends AbstractContainerMenu {
    ...
    public blockCuttingStationMenu (int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        ...
        ItemCapabilityMenuHelper.getCapabilityItemHandler(this.level, this.blockEntity).ifPresent(handler -> {
