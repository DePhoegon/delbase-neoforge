...
public class blockCuttingStationScreen extends AbstractContainerScreen<blockCuttingStationMenu> {
    private static final ResourceLocation EMPTY_TEXTURE =
            new ResourceLocation(MODID, "textures/gui/block_cutting_station_gui_empty.png");
    private static final ResourceLocation COMPOUND_TEXTURE =
            new ResourceLocation(MODID, "textures/gui/block_cutting_station_gui_compound.png");
    private static final ResourceLocation PLANS_WALL_TEXTURE =
            new ResourceLocation(MODID, "textures/gui/block_cutting_station_gui_wall.png");
    private static final ResourceLocation PLANS_SLAB_TEXTURE =
            new ResourceLocation(MODID, "textures/gui/block_cutting_station_gui_slab.png");
    private static final ResourceLocation PLANS_STAIR_TEXTURE =
            new ResourceLocation(MODID, "textures/gui/block_cutting_station_gui_stair.png");
    private static final ResourceLocation PLANS_FENCE_TEXTURE =
            new ResourceLocation(MODID, "textures/gui/block_cutting_station_gui_fence.png");
    private static final ResourceLocation PLANS_FENCE_GATE_TEXTURE =
            new ResourceLocation(MODID, "textures/gui/block_cutting_station_gui_fence_gate.png");
