...
public class wallStones {
    ...
    public static final DeferredBlock<WallBlock> STONE_WALL = register("stone_wall",
            () -> new wallBlock(BlockBehaviour.Properties.ofFullCopy(STONE).sound(SoundType.STONE), false, 0, 0, null));
    public static final DeferredBlock<WallBlock> DEEPSLATE_WALL = register("deepslate_wall",
