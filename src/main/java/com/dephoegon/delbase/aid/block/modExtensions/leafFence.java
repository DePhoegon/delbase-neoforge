...
public class leafFence extends fenceBlock {
    public leafFence(Block block, SoundType type, @NotNull String normToolTip, String shiftToolTip, String ctrlToolTip, boolean flames, BlockState strippedState) {
    ...
    public leafFence(Block block, SoundType type, boolean flames, BlockState strippedState) {
