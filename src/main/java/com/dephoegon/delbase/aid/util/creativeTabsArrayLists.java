...
import static com.dephoegon.delbase.block.fence.fenceQuartz.*;
import static com.dephoegon.delbase.block.fence.fenceSand.*;
import static com.dephoegon.delbase.block.fence.fenceSandStone.*;
import static com.dephoegon.delbase.block.fence.fenceSmoothSandStone.*;
import static com.dephoegon.delbase.block.fence.fenceStone.*;
import static com.dephoegon.delbase.block.fence.fenceStrippedWooden.*;
import static com.dephoegon.delbase.block.fence.fenceTerracotta.*;
import static com.dephoegon.delbase.block.fence.fenceWooden.*;
...
public class creativeTabsArrayLists {
    ...
    public static @NotNull ArrayList<DeferredBlock<FenceBlock>> setWaxedCoperFences() {
        ...
        out.add(WAXED_CHISELED_COPPER_FENCE);
        out.add(WAXED_CHISELED_EXPOSED_COPPER_FENCE);
        out.add(WAXED_CHISELED_WEATHERED_COPPER_FENCE);
        out.add(WAXED_CHISELED_OXIDIZED_COPPER_FENCE);
    ...
    public static @NotNull ArrayList<DeferredBlock<FenceGateBlock>> setWaxedCoperFenceGates() {
        ...
        out.add(WAXED_CHISELED_COPPER_FENCE_GATE);
        out.add(WAXED_CHISELED_EXPOSED_COPPER_FENCE_GATE);
        out.add(WAXED_CHISELED_WEATHERED_COPPER_FENCE_GATE);
        out.add(WAXED_CHISELED_OXIDIZED_COPPER_FENCE_GATE);
    ...
    public static @NotNull ArrayList<DeferredBlock<WallBlock>> setWaxedCopperWalls() {
        ...
        out.add(RAW_WAXED_EXPOSED_COPPER_WALL);
        out.add(RAW_WAXED_WEATHERED_COPPER_WALL);
        out.add(RAW_WAXED_OXIDIZED_COPPER_WALL);
...
/*
    ...
    public static @NotNull ArrayList<DeferredBlock<StairBlock>> setWaxedCopperStairs() {
        ...
        out.add(WAXED_CHISELED_COPPER_STAIR);
        out.add(WAXED_CHISELED_EXPOSED_COPPER_STAIR);
        out.add(WAXED_CHISELED_WEATHERED_COPPER_STAIR);
        out.add(WAXED_CHISELED_OXIDIZED_COPPER_STAIR);
    ...
    public static @NotNull ArrayList<DeferredBlock<SlabBlock>> setWaxedCopperSlabs() {
        ...
        out.add(WAXED_CHISELED_COPPER_SLAB);
        out.add(WAXED_CHISELED_EXPOSED_COPPER_SLAB);
        out.add(WAXED_CHISELED_WEATHERED_COPPER_SLAB);
        out.add(WAXED_CHISELED_OXIDIZED_COPPER_SLAB);
